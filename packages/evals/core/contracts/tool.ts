...
import type { AgentMount } from "@browserbasehq/stagehand-integrations/harness";
...
export {
  AGENT_RUN_TOOL_NAME,
  AGENT_RUN_TOOL_RESERVED_HANDLES,
  AGENT_RUN_TOOL_SERVER,
} from "@browserbasehq/stagehand-integrations/harness";
export type { AgentMount, AgentRunToolSpec } from "@browserbasehq/stagehand-integrations/harness";
